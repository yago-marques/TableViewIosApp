...
final class HomeView: UITableViewController {
    private var controller: HomeControllerDelegate
    ...
    init(controller: HomeControllerDelegate) {
    ...
    override func viewDidLoad() {
        ...
        controller.coordinator.navigator = self.navigationController
    }

    override func viewWillAppear(_ animated: Bool) {
        super.viewWillAppear(animated)

        controller.populateViews()
    }
}
